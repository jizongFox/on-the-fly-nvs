...
def get_args():
    parser = argparse.ArgumentParser(
        description="Options for data loading and training"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=-1.0,
        help="Downsampling ratio for input images",
    )
    parser.add_argument(
        "--pyr_levels",
        type=int,
    ...
    ## COLMAP options
    parser.add_argument(
        "--eval_poses", action="store_true", help="Compare poses to COLMAP"
    )
    parser.add_argument(
        "--use_colmap_poses",
        action="store_true",
    ...
    ## Learning Rates
    parser.add_argument(
        "--lr_poses", type=float, default=1e-4, help="Pose learning rate"
    )
    parser.add_argument(
        "--lr_exposure",
        type=float,
    ...
    parser.add_argument(
        "--feature_lr", type=float, default=0.005, help="Feature learning rate"
    )
    parser.add_argument(
        "--opacity_lr", type=float, default=0.1, help="Opacity learning rate"
    )
    parser.add_argument(
        "--scaling_lr", type=float, default=0.01, help="Scaling learning rate"
    )
    parser.add_argument(
        "--rotation_lr", type=float, default=0.002, help="Rotation learning rate"
    )

    ## Training schedule and losses
    parser.add_argument(
        "--lambda_dssim", type=float, default=0.2, help="Weight for DSSIM loss"
    )
    parser.add_argument(
        "--num_iterations",
        type=int,
    ...
    ## Viewer
    parser.add_argument(
        "--viewer_mode", choices=["local", "server", "web", "none"], default="none"
    )
    parser.add_argument(
        "--ip",
        type=str,
